...
<script>
    $(document).ready(function(){
      ...
      $(document).on('mouseover','.side_menu',function(e){
         e.preventDefault(); $('.list_load, .list_item').stop();
         $('.list_load').removeClass('closed').addClass('opened');
      ...
      $(document).on('mouseleave','.side_menu',function(e){
         e.preventDefault(); $('.list_load, .list_item').stop();
         $('.list_load').removeClass('opened').addClass('closed');
